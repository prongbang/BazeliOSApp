...
_SETTINGS = {
    "arm64-apple-ios-simulator iOSApp.app/iOSApp": {
        "c": "-iquote$(PROJECT_DIR) -iquote$(BAZEL_OUT)/ios_sim_arm64-dbg-ios-sim_arm64-min17.0-applebin_ios-ST-11b564fb2b70/bin -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all",
    },
}
